...
中段推进可由阶段成果连接：本场取得的条件使后续行动成为可能，完成标准也可随人物认识而深化。伏笔安排当前用途及以后重释的后果，多线切换照看原线留下的关切与接入线的作用；具体方法按需读[场景与编排](references/mckee-scenes.md)，成果与联系仍写入现有场景结果、因果链和 handoff。
