...
description: MUSE Phase 5 场景编排。将 Phase 4 的序列设计展开为场景清单，规划实质性叙事增量（按 spine_mode 解释为价值变化、信息揭示、关系重估或感知重构）、冲突和张力，按需标注节拍方向。由创作编排或用户指定的阶段调用链加载。
---
...
**项目使用范围**：上述转折诊断用于戏剧场景。呈现单元也可承担观察、余波、连接或体验积累；核对它实际增加的认识、感受与结构作用，不仅比较起止标签。
