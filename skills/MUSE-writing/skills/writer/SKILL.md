...
**潜在收益不替动作自证**：scene card 或任务背景写“这样以后更快 / 更安全 / 更专业”，而本场没有相应后果，也没有形成独立的感受、声音或形式作用时，给出整备后的结果或直接省略。不要追加解释句，也不要临时增设事故来兑现候选素材。例如“大夫把止血带、剪刀、纱布逐项放好，因为这样取用更快”仍是操作报账；本场若只需要他已准备妥当，写到结果即止。若突发出血已经属于本场核心因果，器材位置确实改变抢救窗口，才让读者经历必要的取用次序。
...
交稿前按已加载的 [prose-craft 信息与过程取舍](../prose-craft/SKILL.md#组织场景与段落)核对有疑点的重复和展开。保留本作实际产生的体验、声音、节奏与结构作用；候选动作的潜在便利不能靠新增事故或解释自证。场景交付同时保留必要事实、人物知识与 handoff，形式标签本身不代替成品判断。
...
- 强动作、物件或身体体验后的解释若只结算已有意义，删去或合并；若形成符合人物自知、叙述距离与文体的新认识，保留其心理过程。连接词或抽象程度本身不决定取舍
