...
《故事》第六章讨论前提与主控思想：前提开启探索，主控思想由关键价值变化及其原因表达。结局帮助检验解释，关键过程也可能支持多义或反证；不据此规定倒序阅读。
...
story_climax_design:            # 记录实际整体结果；开放结尾按原作说明
  crisis:
    dilemma: 原作存在的选择困境
    option_a: 实际选项
    option_b: 实际选项
...
原作未安排两难选择、独立高潮或明确答案时，保留实际收束方式。人物应当得到什么是评价，不能充作其不自觉欲望。
